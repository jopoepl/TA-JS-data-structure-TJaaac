...
console.log(movies[1].genres[movies[1].genres.length - movies[1].genres.length])
...
// 24. Log if the title of the first movie is `Hannah` or not
  ...
  console.log(movies[0].title === `Hannah` ? true: false)
